...
from extensions import login_manager  #local LoginManager

#point Flask-Login at the correct login view
login_manager.login_view = "views.login"

#load environment
load_dotenv(".env")#as in app.py, not secure, see comments
...
USERS = {
    "admin":    "password123",#yet again, all smoke and mirrors
...
FLIGHT_XLSX_DIR = "./json_data"
flight_paths = {#ONLY SIMULATED FLIGHTS
...
#BACKEND PAGES
#unprotected POST: receive JSON via API key - do not do this irl
...
def receive_data():
    ...
    #compute the deviation from flight path
